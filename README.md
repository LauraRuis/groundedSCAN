...
The predicted commands file must be a file generated by the predict function in the [provided model code](https://github.com/LauraRuis/multimodal_seq2seq_gSCAN). The error analysis will generate plots in
